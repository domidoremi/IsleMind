...
check('all themes retain Animal Island contracts', ['minimal', "'lime-road'", 'markdown'].every((theme) => themeContract.includes(theme)) && /animalIslandUi: 'fused'/.test(themeMotion), 'all themes support Isle primitives while Lime Road records the visual fusion')
