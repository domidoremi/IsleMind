...
export function getConversationMetrics(conversation: Conversation | null | undefined): ConversationMetrics {
  ...
  return messages.reduce<ConversationMetrics>(
    ...
    { inputTokens: 0, outputTokens: 0, totalTokens: 0, cacheCreationInputTokens: 0, cacheReadInputTokens: 0, cachedInputTokens: 0, reasoningTokens: 0, estimated: false, durationMs: 0, messageCount: 0, sourceCount: 0 }
  )
}
...
export function usageFromMetrics(metrics: ConversationMetrics): MessageUsage {
  return {
    ...
    ...(metrics.cacheCreationInputTokens ? { cacheCreationInputTokens: metrics.cacheCreationInputTokens } : {}),
    ...(metrics.cacheReadInputTokens ? { cacheReadInputTokens: metrics.cacheReadInputTokens } : {}),
