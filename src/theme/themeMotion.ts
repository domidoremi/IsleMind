...
export const THEME_EXPERIENCE_EXTENSIONS = {
  ...
  monet: {
    ...
    motion: {
      id: 'monet-breathe',
      page: sequence(frame(0, 5, 3, 0.995), frame(0, 4, -2, 1.004), 320, 0, true),
      section: sequence(frame(0, -1, 4, 0.995), frame(0, 1, -3, 1.004), 280, 24),
      scenic: sequence(frame(0, 4, 4, 0.99), frame(0, -3, -3, 1.006), 360, 28, true),
      accent: sequence(frame(0, -1, 2, 0.99), frame(0, 1, -1, 1.004), 220, 20),
      overlay: sequence(frame(0, -1, 5, 0.995), frame(0, 1, -3, 1.004), 300, 0),
  ...
  material: {
    ...
    motion: {
      ...
      page: sequence(frame(0, 10, 0, 0.98), frame(0, -8, 0, 1.01), 220, 0, true),
      section: sequence(frame(0, 6, 0, 0.99), frame(0, -4, 0, 1.005), 180, 12, true),
      scenic: sequence(frame(0, 8, 0, 0.985), frame(0, -5, 0, 1.008), 220, 10, true),
      accent: sequence(frame(0, 0, 0, 0.97), frame(0, 0, 0, 1.015), 140, 8),
      overlay: sequence(frame(0, 0, 8, 0.98), frame(0, 0, -4, 1.01), 200, 0),
