...
export const ISLE_ANIMATIONS: Record<HomePetAnimation, IsleAnimationDefinition> = {
  ...
  memoryLinking: { atlasId: 'rag', row: 5, frames: 6, fps: 6, fallbackAnimation: 'review' },
  graphMapping: { atlasId: 'rag', row: 6, frames: 8, fps: 6, fallbackAnimation: 'review' },
  citationReview: { atlasId: 'rag', row: 7, frames: 6, fps: 5, fallbackAnimation: 'review' },
  knowledgeIndexing: { atlasId: 'rag', row: 8, frames: 8, fps: 7, fallbackAnimation: 'running' },
  ...
  attachmentReading: { atlasId: 'provider', row: 5, frames: 6, fps: 5, fallbackAnimation: 'review' },
  webSearching: { atlasId: 'provider', row: 6, frames: 8, fps: 9, fallbackAnimation: 'runningRight' },
