...
import { PRODUCT_MOBILE_COMPOSER_COMPACT_BREAKPOINT, PRODUCT_MOBILE_READING_COLUMN_MAX_WIDTH, resolveProductMobileComposerLayout } from '@/presentation/layout/productMobileLayout'
