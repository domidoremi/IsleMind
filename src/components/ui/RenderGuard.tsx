        ...
        <View style={{ flexDirection: 'row', gap: 9, alignItems: 'flex-start' }}>
          ...
          <View style={{ flex: 1, minWidth: 0 }}>
            ...
            <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 7, marginTop: 10 }}>
              <IslandButton compact label={strings.retryRender} icon={<RotateCcw color={colors.textSecondary} size={13} strokeWidth={2} />} onPress={this.reset} />
              {this.props.fallbackText ? (
                <IslandButton compact label={strings.copyRaw} icon={<Copy color={colors.textSecondary} size={13} strokeWidth={2} />} onPress={this.copyFallback} />
              ) : null}
            </View>
          </View>
        </View>
