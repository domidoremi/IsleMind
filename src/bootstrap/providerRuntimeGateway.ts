...
import type { ProviderRuntimePipelineResult } from '@/bootstrap/providerRuntimePipeline'
import { runtimeLogOptions } from '@/bootstrap/providerRuntimeDiagnostics'
...
export interface ProviderRuntimeGatewayOutcome {
  ...
  sessionId?: string
  providerId: string
  providerType: ProviderRuntimeChatRequest['provider']['type']
