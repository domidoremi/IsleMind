...
import type { ProviderPayloadRuleResult as PayloadRuleResult } from '@/modules/providers'
import type { ProxyPolicyDecision } from '@/modules/providers'
import type { AccessPolicyDecision } from '@/bootstrap/providerModelAccess'
import type { ProviderFailoverDecision, ProviderFailureClassification } from '@/modules/providers'
...
export function buildProviderConformanceLogData(req: ProviderRuntimeRequestLogLike, result: ProviderConformanceResult): Record<string, unknown> {
  return {
    ...
    bodyKeys: result.bodyKeys,
    parameterDiagnostics: result.parameterDiagnostics,
  }
}
