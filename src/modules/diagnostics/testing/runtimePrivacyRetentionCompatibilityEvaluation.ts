...
export interface RuntimePrivacyRetentionPolicy {
  ...
  portableExportSanitizesMcpServers: boolean
  ...
  generatedArtifactManifestSchema: typeof MEDIA_GENERATION_ARTIFACT_MANIFEST_SCHEMA
  generatedArtifactManifestRequired: boolean
  generatedArtifactLocalUriOnly: boolean
  generatedArtifactPromptDigestOnly: boolean
  generatedArtifactRawProviderPayloadBlocked: boolean
  generatedArtifactRetentionCleanupProven: boolean
  generatedArtifactCancellationLinked: boolean
  mediaGenerationAdapterImplemented: boolean
  mediaGenerationExecutionActionsAllowed: boolean
  mediaGenerationDefaultEnablementBlocked: boolean
...
const SAFE_RUNTIME_PRIVACY_RETENTION_POLICY: RuntimePrivacyRetentionPolicy = {
  ...
  portableExportSanitizesMcpServers: true,
  ...
  generatedArtifactManifestSchema: MEDIA_GENERATION_ARTIFACT_MANIFEST_SCHEMA,
  generatedArtifactManifestRequired: true,
  generatedArtifactLocalUriOnly: true,
  generatedArtifactPromptDigestOnly: true,
  generatedArtifactRawProviderPayloadBlocked: true,
  generatedArtifactRetentionCleanupProven: true,
  generatedArtifactCancellationLinked: true,
  mediaGenerationAdapterImplemented: MEDIA_GENERATION_ADAPTER_IMPLEMENTED,
  mediaGenerationExecutionActionsAllowed: summarizeMediaGenerationAdapterProofWorklist().composerExecutionActionAllowed,
  mediaGenerationDefaultEnablementBlocked: summarizeMediaGenerationAdapterProofWorklist().defaultEnablementBlocked,
...
export const RUNTIME_PRIVACY_RETENTION_COMPATIBILITY_FIXTURES: RuntimePrivacyRetentionFixture[] = [
  ...
  },
  {
    ...
    expectedReadiness: 'ready',
    description: 'Portable exports sanitize providers, settings URL fields, traces, attachments, skills, and MCP server metadata before serialization.',
    policy: SAFE_RUNTIME_PRIVACY_RETENTION_POLICY,
  },
  {
  ...
  {
    id: 'generated-media-artifact-cleanup-proof',
    surface: 'media-generation',
    expectedReadiness: 'ready',
    description: 'Future generated media artifacts require a local manifest, prompt digest, cleanup proof, cancellation linkage, and hidden execution actions until the adapter proof worklist is captured.',
    policy: SAFE_RUNTIME_PRIVACY_RETENTION_POLICY,
  },
  {
  ...
  {
    id: 'blocked-generated-media-artifact-cleanup',
    surface: 'blocked',
    expectedReadiness: 'blocked',
    description: 'Generated media without a manifest, local-only storage, prompt digest, cleanup proof, cancellation linkage, or disabled execution actions fails closed.',
    policy: {
      ...SAFE_RUNTIME_PRIVACY_RETENTION_POLICY,
      generatedArtifactManifestRequired: false,
      generatedArtifactLocalUriOnly: false,
      generatedArtifactPromptDigestOnly: false,
      generatedArtifactRawProviderPayloadBlocked: false,
      generatedArtifactRetentionCleanupProven: false,
      generatedArtifactCancellationLinked: false,
      mediaGenerationExecutionActionsAllowed: true,
      mediaGenerationDefaultEnablementBlocked: false,
    },
  },
  {
  ...
  },
  {
    ...
    policy: {
      ...
      portableExportSanitizesMcpServers: false,
    },
  },
  {
...
export function evaluateRuntimePrivacyRetentionCompatibilityQualityGate(
  ...
  requireBlocked(byId.get('blocked-generated-media-artifact-cleanup'), failures, 'blocked-generated-media-artifact-cleanup', [
    'missing-generated-artifact-manifest',
    'generated-artifact-raw-payload-retained',
    'generated-artifact-cleanup-missing',
    'generated-artifact-cancellation-missing',
...
function requireBaselineRuntimePrivacyRetentionPolicy(item: RuntimePrivacyRetentionDiagnostic, failures: string[]): void {
  ...
  if (!policy.portableExportSanitizesProviders || !policy.portableExportSanitizesSettingsUrls || !policy.portableExportSanitizesTraces || !policy.portableExportSanitizesAttachments || !policy.portableExportSanitizesSkills || !policy.portableExportSanitizesMcpServers) failures.push(`${item.fixtureId}:missing-portable-export-sanitization`)
  ...
  if (policy.generatedArtifactManifestSchema !== MEDIA_GENERATION_ARTIFACT_MANIFEST_SCHEMA || !policy.generatedArtifactManifestRequired || !policy.generatedArtifactLocalUriOnly || !policy.generatedArtifactPromptDigestOnly) failures.push(`${item.fixtureId}:missing-generated-artifact-manifest`)
  if (!policy.generatedArtifactRawProviderPayloadBlocked) failures.push(`${item.fixtureId}:generated-artifact-raw-payload-retained`)
  if (!policy.generatedArtifactRetentionCleanupProven) failures.push(`${item.fixtureId}:generated-artifact-cleanup-missing`)
  if (!policy.generatedArtifactCancellationLinked) failures.push(`${item.fixtureId}:generated-artifact-cancellation-missing`)
  if (policy.mediaGenerationAdapterImplemented || policy.mediaGenerationExecutionActionsAllowed || !policy.mediaGenerationDefaultEnablementBlocked) failures.push(`${item.fixtureId}:media-generation-execution-enabled`)
...
function collectRuntimePrivacyRetentionFailureCodes(
  ...
  if (policy.generatedArtifactManifestSchema !== MEDIA_GENERATION_ARTIFACT_MANIFEST_SCHEMA || !policy.generatedArtifactManifestRequired || !policy.generatedArtifactLocalUriOnly || !policy.generatedArtifactPromptDigestOnly) failures.push('missing-generated-artifact-manifest')
  if (!policy.generatedArtifactRawProviderPayloadBlocked) failures.push('generated-artifact-raw-payload-retained')
  if (!policy.generatedArtifactRetentionCleanupProven) failures.push('generated-artifact-cleanup-missing')
  if (!policy.generatedArtifactCancellationLinked) failures.push('generated-artifact-cancellation-missing')
  if (policy.mediaGenerationAdapterImplemented || policy.mediaGenerationExecutionActionsAllowed || !policy.mediaGenerationDefaultEnablementBlocked) failures.push('media-generation-execution-enabled')
