...
/** Identifies Azure OpenAI without relying on mutable model-list contents. */
...
/** Returns true only for the resource-scoped Azure v1 route supported by the runtime. */
...
/** Keeps legacy deployment/api-version routes explicit instead of rewriting them as v1 routes. */
...
/** Normalizes supported Azure resource routes to the canonical `/openai/v1` namespace. */
