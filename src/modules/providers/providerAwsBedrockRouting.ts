...
import { signAwsRequestV4, type AwsCredentials } from './providerAwsSigV4'
import { resolveProviderClientSimulationPolicy } from './providerClientSimulationPolicy'
...
export function prepareBedrockRuntimeInvokeModelRequest(input: BedrockRuntimeRequestInput): PreparedBedrockRuntimeRequest {
  ...
  const headers = signAwsRequestV4({
    ...
    headers: {
      ...
      'User-Agent': resolveProviderClientSimulationPolicy({
