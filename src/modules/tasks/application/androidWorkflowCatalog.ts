...
export const ANDROID_BUILT_IN_WORKFLOW_IDS = Object.freeze([
...
export type AndroidBuiltInWorkflowId = (typeof ANDROID_BUILT_IN_WORKFLOW_IDS)[number]
...
export interface AndroidWorkflowCatalogDependencies {
  definitionPolicy: Pick<WorkflowDefinitionPolicy, 'create'>
  sanitizeApkUri(value: string | undefined): string | undefined
}

export interface AndroidWorkflowCatalog {
  list(input?: CreateAndroidBuiltInWorkflowInput): WorkflowDefinitionRecord[]
  isBuiltInWorkflowId(workflowId: string): workflowId is AndroidBuiltInWorkflowId
}

export function createAndroidWorkflowCatalog(
  dependencies: AndroidWorkflowCatalogDependencies,
): AndroidWorkflowCatalog {
  function createAndroidDownloadOrganizeWorkflowDefinition(
    input: CreateAndroidBuiltInWorkflowInput = {},
  ): WorkflowDefinitionRecord {
    const directoryUri = sanitizeDirectoryUri(input.directoryUri)
    return dependencies.definitionPolicy.create({
  ...
  function createAndroidFileCopyRenameWorkflowDefinition(
    input: CreateAndroidBuiltInWorkflowInput = {},
  ): WorkflowDefinitionRecord {
  ...
  function createAndroidApkInstallWorkflowDefinition(
    input: CreateAndroidBuiltInWorkflowInput = {},
  ): WorkflowDefinitionRecord {
    const apkUri = dependencies.sanitizeApkUri(input.apkUri)
  ...
  function createAndroidAppCacheCleanupWorkflowDefinition(
    input: CreateAndroidBuiltInWorkflowInput = {},
  ): WorkflowDefinitionRecord {
    return dependencies.definitionPolicy.create({
  ...
  function createAndroidAlarmWorkflowDefinition(
    input: CreateAndroidBuiltInWorkflowInput = {},
  ): WorkflowDefinitionRecord {
    return dependencies.definitionPolicy.create({
  ...
  function createAndroidCalendarTodoWorkflowDefinition(
    input: CreateAndroidBuiltInWorkflowInput = {},
  ): WorkflowDefinitionRecord {
    return dependencies.definitionPolicy.create({
  ...
  function createAndroidNotificationSettingsWorkflowDefinition(
    input: CreateAndroidBuiltInWorkflowInput = {},
  ): WorkflowDefinitionRecord {
    return dependencies.definitionPolicy.create({
  ...
  return {
    ...
    isBuiltInWorkflowId(workflowId: string): workflowId is AndroidBuiltInWorkflowId {
      return (ANDROID_BUILT_IN_WORKFLOW_IDS as readonly string[]).includes(workflowId)
    },
  }
}
...
function buildFileCopyRenamePreviewArguments(
  input: CreateAndroidBuiltInWorkflowInput,
