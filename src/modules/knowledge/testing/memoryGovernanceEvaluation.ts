import type {
  KnowledgeMemorySourceKind as MemorySourceKind,
  KnowledgeMemoryStatus as MemoryStatus,
} from '../contracts'

// Test-only compatibility data; preserve the frozen v1 schema and fixture behavior.
