...
export const DEFAULT_MODELS: AIModel[] = [
  ...
  model('zai-glm-4.7', 'Z.ai GLM 4.7', 'openai-compatible', 131000, 40000, 8192, false, false, false, { supportsTools: true, reasoningMode: 'cerebras-reasoning-effort', reasoningEfforts: ['none'], sourceUrl: 'https://inference-docs.cerebras.ai/models/zai-glm-47.md', verifiedAt: '2026-06-21' }),
