...
export const DEFAULT_MODELS: AIModel[] = [
  model('gpt-5.6-sol', 'GPT-5.6 Sol', 'openai', 1050000, 128000, 8192, true, false, false, { supportsTools: true, preferredEndpoint: 'responses', reasoningMode: 'openai-effort', reasoningEfforts: ['none', 'low', 'medium', 'high', 'xhigh', 'max'], sourceUrl: 'https://developers.openai.com/api/docs/models/gpt-5.6-sol', verifiedAt: '2026-08-26' }),
  ...
  model('claude-fable-5', 'Claude Fable 5', 'anthropic', 1000000, 128000, 8192, true, true, false, { supportsTools: true, reasoningMode: 'anthropic-thinking', reasoningEfforts: ['low', 'medium', 'high', 'xhigh', 'max'], sourceUrl: 'https://platform.claude.com/docs/en/models/overview', verifiedAt: '2026-08-26' }),
  ...
  model('deepseek-v4-pro', 'DeepSeek V4 Pro', 'openai-compatible', 1000000, 384000, 8192, false, false, false, { supportsTools: true, reasoningMode: 'deepseek-thinking', reasoningEfforts: ['none', 'high', 'xhigh'], sourceUrl: 'https://api-docs.deepseek.com/api/create-chat-completion', verifiedAt: '2026-08-26' }),
  model('deepseek-v4-flash', 'DeepSeek V4 Flash', 'openai-compatible', 1000000, 384000, 8192, false, false, false, { supportsTools: true, reasoningMode: 'deepseek-thinking', reasoningEfforts: ['none', 'high', 'xhigh'], sourceUrl: 'https://api-docs.deepseek.com/api/create-chat-completion', verifiedAt: '2026-08-26' }),
  model('deepseek-v4-flash-vision-exp', 'DeepSeek V4 Flash Vision (Experimental)', 'openai-compatible', 1000000, 384000, 8192, true, false, true, { supportsTools: true, reasoningMode: 'deepseek-thinking', reasoningEfforts: ['none', 'high', 'xhigh'], sourceUrl: 'https://api-docs.deepseek.com/api/create-chat-completion', verifiedAt: '2026-08-26', deprecatedReason: 'Experimental vision endpoint; use deepseek-v4-flash for stable text workloads.' }),
  model('deepseek-chat', 'DeepSeek Chat', 'openai-compatible', 1000000, 384000, 8192, false, false, true, { supportsTools: true, sourceUrl: 'https://api-docs.deepseek.com/updates', verifiedAt: '2026-08-26', deprecatedReason: 'Retired compatibility alias after 2026-07-24 15:59 UTC; use deepseek-v4-flash.' }),
  ...
  model('qwen3.8-max', 'Qwen3.8 Max', 'openai-compatible', 1000000, 65536, 8192, true, false, false, { supportsTools: true, reasoningMode: 'dashscope-thinking', reasoningEfforts: ['none', 'low', 'medium', 'high'], sourceUrl: 'https://help.aliyun.com/zh/model-studio/text-generation-model', verifiedAt: '2026-08-26' }),
  ...
  model('glm-5.3', 'GLM-5.3', 'openai-compatible', 200000, 128000, 8192, false, false, false, { supportsTools: true, reasoningMode: 'dashscope-thinking', reasoningEfforts: ['none', 'low', 'medium', 'high'], sourceUrl: 'https://docs.bigmodel.cn/cn/guide/start/model-overview', verifiedAt: '2026-08-26' }),
  ...
  model('gpt-oss-120b', 'GPT OSS 120B', 'openai-compatible', 131000, 40000, 8192, false, false, false, { supportsTools: true, reasoningMode: 'cerebras-reasoning-effort', reasoningEfforts: ['low', 'medium', 'high'], sourceUrl: 'https://inference-docs.cerebras.ai/models/openai-oss.md', verifiedAt: '2026-06-21' }),
  ...
  model('command-a-03-2025', 'Command A', 'openai-compatible', 256000, 8192, 4096, true, false, false, { supportsTools: true, sourceUrl: 'https://docs.cohere.com/v2/docs/models', verifiedAt: '2026-08-26' }),
  ...
  model('command-r-08-2024', 'Command R 08-2024', 'openai-compatible', 128000, 4096, 2048, true, false, false, { supportsTools: true, sourceUrl: 'https://docs.cohere.com/v2/docs/models', verifiedAt: '2026-08-26' }),
