...
import type { WorkflowMessagePendingAction, WorkflowStepToolRequest } from '@/modules/tasks'
...
export function resolveConfirmedPendingActionTool(input: {
  ...
  tool?: ConversationToolManifest | null
}): ConversationToolManifest | undefined {
...
export function formatWorkflowSaveBlockedReason(
...
function toolMatchesRequestIdentity(
  request: WorkflowStepToolRequest,
