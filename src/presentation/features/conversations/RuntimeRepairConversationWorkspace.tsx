...
export interface RuntimeRepairChatParams {
  id?: string | string[]
...
interface RuntimeRepairConversationWorkspaceProps {
...
export function RuntimeRepairConversationWorkspace({
  ...
  params,
  onHistory,
}: RuntimeRepairConversationWorkspaceProps) {
  const { t } = useTranslation()
  const runtimeRepairIntent = buildRuntimeRepairIntent(params, conversation, t)
