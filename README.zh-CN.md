...
从 [GitHub Releases](https://github.com/domidoremi/IsleMind/releases/latest) 下载最新 Android APK，然后在设备上安装。Release notes 会提供直接下载链接，因为 GitHub 移动端的 Assets 列表可能截断长文件名。
...
- `arm64-v8a`：多数现代 Android 手机优先选择。
- `x86_64`：Android emulator 使用。
- `armeabi-v7a`：旧 32 位 Android 设备使用。
