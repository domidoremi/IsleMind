...
- Prefer assimilating a useful idea through the [existing owners](./architecture/architecture.md#4-module-ownership) over importing an entire architecture. However, no framework, protocol, model, database, runtime, or retrieval strategy is permanently protected from replacement.
