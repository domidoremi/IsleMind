...
- Isle UI 是受 `animal-island-ui` 启发的 React Native 适配实现。上游项目由 `guokaigdg` 发布，许可证为 CC BY-NC 4.0；IsleMind 不内置上游 React DOM 包、CSS、字体或图片资产：<https://github.com/guokaigdg/animal-island-ui>。
