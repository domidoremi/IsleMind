...
- Isle UI is a React Native adaptation inspired by `animal-island-ui`. The upstream project is authored by `guokaigdg` and is licensed under CC BY-NC 4.0; IsleMind does not vendor the upstream React DOM package, CSS, fonts, or image assets: <https://github.com/guokaigdg/animal-island-ui>.
